		...
		<header class="site-header" id="myHeader">
			<div class="container flex-container">
				<div class="logo flex-container">
					<a href="#"> <img src="assets/images/logo.svg" alt="Weinberg"></a>
					<p>capital</p>
				</div>
			...
			<div class="container flex-container application">
				...
				<div class="application-two">
					...
					<div class="flex-container">
						...
						<a href="#" id="modalFaq" class="faqbutton">Frequently Asked Questions</a>
		...
		<section>
			...
			<div class="container flex-container calculator">
				<div class="calculator-one">
					<h1>Calculate your monthly installment</h1>
					...
					<div  class="tabContainer">
						...
						<div class="tabPanel">
							...
							<p class="readouts">$ <span id="loans"></span></p>
  							...
  							<input type="range" min="1" max="25000" value="8000" class="slider" id="myLoanRange" onchange="computeLoan()">
							</div>
							...
							<p class="readouts"><span id="period"></span> years</p>
  							...
  							<input type="range" min="1" max="5" value="3" class="slider2" id="myPeriodRange" onchange="computeLoan()">
							</div>
						...
						<div class="tabPanel">
							...
							<p class="readouts">$ <span id="loans"></span></p>
  							...
  							<input type="range" min="1" max="10000" value="1000" class="slider" id="myLoanRange" onchange="computeLoan()">
							</div>
							...
							<p class="readouts"><span id="period"></span> years</p>
  							...
  							<input type="range" min="1" max="5" value="4" class="slider2" id="myPeriodRange" onchange="computeLoan()">
							</div>
		...
		<footer class="site-footer">
			<div class="container flex-container">
				<div class="address">
					...
					<a href="#"> <img src="assets/images/capital.svg" alt="Weinberg footer logo"></a>
					<p>Copyright © 2020 Weinberg Capital, Inc.</p>
				</div>
					<div class="map">
